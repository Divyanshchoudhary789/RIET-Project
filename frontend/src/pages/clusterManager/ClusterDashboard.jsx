...
import { FilePlus2, Eye, CheckSquare } from 'lucide-react';
        ...
        {loading ? <div className="page-loader"><span className="spinner" /></div> : requirements.length === 0 ? (
          ...
          <div className="table-wrap">
            <table className="table">
              <thead><tr><th>Description</th><th>Campus</th><th>Priority</th><th>Status</th><th>Date</th><th>Actions</th></tr></thead>
              <tbody>
                {requirements.map((r) => (
                  <tr key={r._id}>
                    <td style={{ maxWidth: 220, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>{r.description || r.justification}</td>
